        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayModel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoadId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BrokerName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LoadNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UnloadedMiles = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LoadedMiles = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PickUpDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeliveryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LoadPay = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    RatePerMile = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DriverId = table.Column<int>(type: "int", nullable: false),
                    TrailerId = table.Column<int>(type: "int", nullable: false),
                    TruckId = table.Column<int>(type: "int", nullable: false)
                },
